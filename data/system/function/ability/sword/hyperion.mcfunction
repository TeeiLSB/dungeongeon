...
execute if score @s CD.default matches 0 as @e[type=!player,distance=..5,limit=200,sort=nearest] run damage @s 5 minecraft:generic by @p


# wither shield
execute if score @s CD.default matches 0 unless score @s CD.hyperion matches 1.. run playsound minecraft:entity.zombie_villager.cure master @s ~ ~ ~ 0.4 0.75
